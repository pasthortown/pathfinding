...
class Paso:
    def __init__(self, pos_actual, ruta, pos_meta, costo_acumulado, mapa):
    ...
    def get_pasos_validos_Manhattan(self):
        ...
        for casilla_valida in casillas_validas:
            ...
            if (self.pos_actual[0] > casilla_valida[0]):
                ...
                costo = 1
            toReturn.append(Paso(casilla_valida, ruta, self.pos_meta, self.costo_acumulado + costo, self.mapa))
        return toReturn
    ...
    def get_pasos_validos_Ecludia(self):
        ...
        for casilla_valida in casillas_validas:
            ...
            if (self.pos_actual[0] > casilla_valida[0]):
                ...
                costo = math.sqrt(math.pow(5,2) + 1)
            else:
